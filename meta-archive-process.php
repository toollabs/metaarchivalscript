...
$settings_match = array ( 	'status_template' 	=> '#\{\{status\|(not )?done\}\}#i',
							'status_param' 		=> '#(\| *status *= *(<!--.*-->)?(not )?done|\{\{status\|(not )?done\}\})#iU',
...
$settings_archives = array (
	...
	'Steward requests/Global permissions' => array(	'subpage' => 'Steward requests/Global permissions/',
													'nbdays' => 1,
													'subsections' => array('Requests for global rollback permissions','Requests for global sysop permissions','Requests for global editinterface permissions','Requests for global IP block exemption'),
	...
	'Steward requests/SUL requests' => array(	'subpage' => 'Steward requests/SUL requests/',
												'nbdays' => 4, // previously 5
												'subsections' => array('Requests'),
												'match' => $settings_match['status_template']),
												
	'Meta:Changing username' => array(	'subpage' => 'Meta:Changing username/Archives/',
										'nbdays' => 3,
										'subsections' => array('Requests'),
										'match' => $settings_match['status_template']),
												
	'Steward requests/Username changes' => array(	'subpage' => 'Steward requests/Username changes/',
													'nbdays' => 4, // previously 3
													'subsections' => array('Requests for renaming your own account','Requests for renaming an account of another person'),
													'match' => $settings_match['status_param'])
	);
...
define ('DONTARCHIVESECT','{{User:QuentinvBot/DoNotArchiveSect}}');
